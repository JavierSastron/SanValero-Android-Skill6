package com.example.sanvalero_android_skill6;
...
import com.example.sanvalero_android_skill6.adapters.RVRetrofitAdapter;
import com.example.sanvalero_android_skill6.networking.ProductResult;
import com.example.sanvalero_android_skill6.networking.RetrofitClient;
    ...
    private void getProducts() {
        ...
        apiCall.enqueue(new Callback<List<ProductResult>>() {
            ...
            public void onResponse(Call<List<ProductResult>> call, Response<List<ProductResult>> response) {
                ...
                Toast.makeText(ActivityRvProducts.this,
                        "Got Products",
